...
/**
 底部安全间距
 */
#define lz_safeBottomMargin  (isIPhoneXSeries() ? 34.f : 0.f)
...
+(UIView*)addTopViewToParentView:(UIView*)parent topLineColor:(UIColor*)lineColor backgroundColor:(UIColor*)backgroundColor{
    ...
    //
    CGPoint p0 = CGPointMake(0.0, lz_tabbarSpaceitem);
    CGPoint p1 = CGPointMake(parent.bounds.size.width/2.0 - lz_tabbarSpacewidth/2.0, lz_tabbarSpaceitem);
    CGPoint p = CGPointMake(parent.bounds.size.width/2.0, 0);
    CGPoint p2 = CGPointMake(parent.bounds.size.width/2.0 + lz_tabbarSpacewidth/2.0, lz_tabbarSpaceitem);
    CGPoint p3 = CGPointMake(parent.bounds.size.width, lz_tabbarSpaceitem);
    //
